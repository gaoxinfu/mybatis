...
public class Configuration {
  ...
  NONE 表示取消自动映射；
  PARTIAL 只会自动映射没有定义嵌套结果集映射的结果集。啥意思？就是如果定义了嵌套结果集映射，用嵌套结果的映射，未在结果resultMap中定义的自动映射
  ...
  /**
   *
   * @param statementName 如 com.gaoxinfu.demo.open.source.mybatis.db.mapper.BlogMapper.selectByPrimaryKey
